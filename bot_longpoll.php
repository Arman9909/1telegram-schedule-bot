...
function handleMessage($telegram, $message)
{
...
// === LONG-POLL ЦИКЛ ===
echo "Бот запущен в long-poll режиме! Ищи его в Telegram и пиши /start\n";
...
while (true) {
    try {
        ...
        foreach ($updates as $update) {
            ...
            if ($message) {
                $messageArray = $message->toArray(); // превращаем в массив
                handleMessage($telegram, $messageArray);
            }
        }
    } catch (Exception $e) {
